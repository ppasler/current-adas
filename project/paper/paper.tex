...
\begin{figure}[h] 
  \begin{center}
    ...
    \caption[Problem]{Das System zur \acl{ME} muss mehrere Probleme im Zusammenhang mit dem Fahrer lösen.\label{fig:ddd_problem}}
  \end{center}
\end{figure}
...
Abbildung \ref{fig:data_stream} zeigt die Gesamtübersicht des entwickelten Systems dar. Alle blauen Klassen der Anwendung wurden in Python 2.7 implementiert. Der Fahrsimulator und seine Schnittstellen (rosa) in Java und C\#.
...
Im ersten Schritt werden die Signale auf das Intervall 1 bis -1 normalisiert, dazu werden die Signale durch den jeweiligen Maximalwert geteilt. Dieses Vorgehen stellt sicher, dass die absolute Amplitude keinen Einfluss auf die Gewichtung im Klassifikator hat. Zudem wird die Datenmenge wiederum reduziert.
