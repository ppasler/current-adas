...
\begin{figure}[h] 
  \begin{center}
    ...
    \caption[Datenverarbeitungskette]{Die Daten werden immer weiter reduziert und verarbeitet. \label{fig:data_processing}}
  \end{center}
\end{figure}
