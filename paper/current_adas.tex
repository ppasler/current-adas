...
\sloppypar{
\begin{abstract}
Mit Fortschreiten der Technik verbreiten sich \acl{FAS}en immer weiter, im Teilbereich der \acl{ME} existieren verschiedenen Ansätze. Die Erkennung mit Body-Sensorik liefert sehr gute Ergebnisse, scheitert aber in der Praxis häufig auf Grund seines invasiven Charakters. Im Simulationsumfeld der \acl{RTU} wird ein Konzept entwickelt, dass Körperfunktionen überwacht und diese auswertet, ohne den Fahrer zu beeinträchtigen. Weiterhin wird die Möglichkeit einer einfachen Portieren der Anwendung vom Simulator in ein echtes Fahrzeug geprüft. Das vorgestellte Konzept, soll somit ein gefordertes Maß an Genauigkeit, Tragekomfort und Mobilität vereinen.
...
\section{Einleitung}
\label{chap:intro}
Fristeten \acl{FASs} vor wenigen Jahren ein Nischendasein in Oberklassewagen, werden sie immer günstiger und beliebter. So halten sie auch in Mittel- und Kleinwagen Einzug und helfen bei der Vermeidung schwerer Unfälle. Die \acl{ME} hilft dem Fahrer und rät ihm zu gegebenen Anlass eine Pause einzulegen. Hierbei zeigt die Erkennung mit Körpersensoren (EEG, EKG) sehr gute Ergebnisse. Der Tragekomfort macht diese Systeme aber für die Praxis meist ungeeignet. \\
...
Die vorhandenen Sensoren sind folgende:
\begin{itemize}
	\item EEG Epoc Emotiv \footnote{\url{https://emotiv.com/epoc.php}}
	\item EKG Zephyr Bioharnes \footnote{\url{http://www.zephyranywhere.com/products/bioharness-3}}
\end{itemize}
...
Videobasierte Systeme erfüllen ebenfalls ihren Zweck, sind aber leicht durch äußere Einflüsse, wie \acl{bspw} Licht, beeinflussbar. Auch wenn Systeme mit Infrarot Kameras diese Problem vermindern, kommt es auch hier zu Problemen mit (Sonnen-)Brillenträgern, da die Augen nicht richtig erkannt werden können. 

Die meisten Body-Sensoren liefern sehr gute Ergebnisse, sind aber wegen ihrer invasiven Eingenschaften (Die Sensoren liegen direkt am Körper an) weniger für den Serienbetrieb geeignet. Um dieses Problem zu lösen, stellte der französische Automobilzulieferer seinen intelligenten Autositz "Active-Wellness" vor. Der Sitz ist mit passiven Sensoren ausgestattet und misst ständig den Herzrhythmus, die Atmung und weitere biometrische Daten, um bei einfallender Müdigkeit gegenzusteuern \footnote{\url{http://www.faurecia.de/node/1780}}. Auch Pulsmesser am Handgelenk werden immer besser und sind dabei nicht größer als eine Uhr und bieten ein vertretbaren Tragekomfort. \\

Aufgrund der hohen Genauigkeit von EEG, EKG und Co. sind diese Systeme zur Validierung anderer Systeme in der Testphase nützlich. Gelingt es zudem den invasiven Charakter gering zu halten oder gar ganz zu vermeiden, sind Systeme mit Body-Sensoren auch für den Produktiveinsatz geeignet. Es bleibt zu zeigen, dass Genauigkeit und Tragekomfort im richtigen Verhältnis stehen. Hat sich ein System in der Simulationsumgebung bewährt, sollte das System in einem realen Fahrzeug getestet werden können.  \\
